...
config = yaml.load(open('./config_files/e_model.yaml', 'r'))
            ...
            with open(log_file_path) as f_log:
                ...
                while True:
                    ...
                    try:
                        ...
                        #图片路径包含两种情况
                        # 1. /facepic/recognition/inpath/20160811/10.33.96.1/image/person1050610097_074144_860000_0629bf86-ff28-4b96-a199-4acb75ffcb82.jpg
                        origin_image_list1 = [os.path.join(parent_path, 'image', p.strip().split('\\')[-1]) for p in origin_image_list]
                        # 2. /facepic/recognition/inpath/log_10.33.96.2/image/20170606/person430122198306071830_235929_724000_c8d77bbe-9e16-492f-98d9-65142c1be2fe.jpg
                        origin_image_list2 = [os.path.join(parent_path, 'image', *p.strip().split('\\')[1:]) for p in origin_image_list]

                        origin_image_list = origin_image_list1 + origin_image_list2
                        origin_image_list = list(set(origin_image_list))
