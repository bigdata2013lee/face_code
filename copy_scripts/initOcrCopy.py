...
ll=os.sep
srcim = "/nfsc/ocr_id_id201211_vol1001_prd/ocr"#源
dstim = "/facepic/ocr_pic/inpath/ocr"#目标
...
#/facepic/ocr_pic/inpath/im/2017/08/19/03
def initCopy():
    begin = datetime(2017, 4, 11, 00)
    end = datetime(2017,10, 16, 23)
    d = begin
